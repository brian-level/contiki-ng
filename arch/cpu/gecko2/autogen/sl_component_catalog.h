...
#define SL_CATALOG_RADIO_CONFIG_RANGE_TEST_DOUBLE_OCELOT_PRESENT
...
#define SL_CATALOG_FLEX_IMAGES_FOR_LCD_PRESENT
...
#define SL_CATALOG_RANGE_TEST_CLI_PRESENT
#define SL_CATALOG_RANGE_TEST_CORE_PRESENT
